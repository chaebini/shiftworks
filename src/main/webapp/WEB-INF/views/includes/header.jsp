				...
				<div class="bottom-border pd-3" id="profile"
					...
					<div class="card-profile" style="">
						...
						<a href="#multiCollapseUser" class="" data-bs-toggle="collapse"
							...
							style="text-decoration: none; color: white;" id="userName"> <svg
					...
					<div class="collapse multi-collapse" id="multiCollapseUser">
						<div class="card card-body"
							...
							<ul>
								...
								<a href="/myaccount/get"><li>나의 계정 관리</li></a>
								<br>
								<a href="/myaccount/orgchart"><li>조직도 보기</li></a>
								<br>
								<a href="/customLogout"><li>로그아웃</li></a>
								<br>
							</ul>
						</div>
						<!-- end card -->
					...
					<div class="collapse multi-collapse" id="multiCollapseAPR">
						<div class="card card-body"
							...
							<ul>
								...
								<br>
								<a href="/approval/receivedList"><li>결재전 문서</li></a>
								<br>
							</ul>
						</div>
					</div>
			...
			<div class="row">
				<div class="col">
					<div class="collapse multi-collapse" id="multiCollapseBOA">
						<div class="card card-body" style="height: 190px;">
							<ul class="board">
			...
			<div class="row">
				<div class="col">
					<div class="collapse multi-collapse" id="multiCollapseDOC">
						<div class="card card-body" style="height: 130px;">
							<ul>
